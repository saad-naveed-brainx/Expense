        ...
        <div className='w-full'>
          <form className='p-10 flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              />
              <input type="date" onFocus={() => setFocused(true)}
          onBlur={() => setFocused(false)} placeholder='Select Date' className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("date", {required:true})} />
            </div>
          </form>
        </div>
