        ...
        <div className='w-full'>
          <form className='p-10 flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <input type="number" className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("amount", {required:true})} />
              <input type="date" className='bg-gray-700 rounded-md p-2 flex-1 min-w-0 w-full' {...register("date", {required:true})} />
            </div>
          </form>
        </div>
