            ...
            <div className='h-full w-full'>
                <div className='text-white'>
                    <div className='w-full rounded-2xl border border-gray-800'>
                        ...
                        {showDeleteModal && (
                            <div className='fixed inset-0 bg-opacity-10 bg-opacity-50 flex items-center justify-center'>
                                <div className='bg-white rounded-md p-4 flex flex-col gap-4'>
                                    <h2 className='text-2xl font-semibold'>Delete Expense</h2>
                                </div>
                                <div className='flex items-center gap-2'>
                                                ...
                                                expenses.map((expense) => (
                                                    <tr key={expense.id}>
                                                        ...
                                                        <td className='py-4 px-6 font-semibold flex items-center gap-8 justify-end'>
                                                            ...
                                                            <button className='text-red-300' onClick={() => setShowDeleteModal(true)}>
