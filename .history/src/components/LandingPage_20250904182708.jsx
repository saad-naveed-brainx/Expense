...
export default function LandingPage() {
  ...
  if(expenses.length === 0) {
    localStorage.getItem('expenses') && localStorage.setItem('expenses', JSON.stringify(expenses))
  }

  const recentExpenses = expenses.filter((expense) => expense.date >= new Date(new Date().setDate(new Date().getDate() - 1)))
