          ...
          <form id='expenseForm' className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <div className='flex-1 flex flex-col gap-1'>
                <select className='bg-gray-700 rounded-md p-3 w-full' {...register("category", { required:"Category must be selected" })}>
                  <option value="" disabled className='text-green-400'>Select Category</option>
