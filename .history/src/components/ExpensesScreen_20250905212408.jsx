                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-'>Title</th>
                                            <th className='py-3 px-6 text-left font-'>Category</th>
                                            <th className='py-3 px-6 text-left font-'>Date</th>
                                            <th className='py-3 px-6 text-left font-'>Amount</th>
                                            <th className='py-3 px-6 text-left font-'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
