                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left text-xl'>Title</th>
                                            <th className='py-3 px-6 text-left text-xl'>Category</th>
                                            <th className='py-3 px-6 text-left text-xl'>Date</th>
                                            <th className='py-3 px-6 text-left text-xl'>Amount</th>
                                            <th className='py-3 px-6 text-left text-xl'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
