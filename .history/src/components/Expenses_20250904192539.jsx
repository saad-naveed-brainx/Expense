        ...
        <div className='w-full'>
          <form id='expenseForm' className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <select placeholder='Select Category' className='bg-gray-700 rounded-md p-3 flex-1 min-w-0' {...register("category", { required: true, minLength: { value: 3, message: "Category must be at least 3 characters long" }, pattern: { value: /^[a-zA-Z]+$/, message: "Category must contain only letters" } })}>
