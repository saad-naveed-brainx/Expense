                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-l'>Title</th>
                                            <th className='py-3 px-6 text-left font-l'>Category</th>
                                            <th className='py-3 px-6 text-left font-l'>Date</th>
                                            <th className='py-3 px-6 text-left font-l'>Amount</th>
                                            <th className='py-3 px-6 text-left font-l'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
