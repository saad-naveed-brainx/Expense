                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-la'>Title</th>
                                            <th className='py-3 px-6 text-left font-la'>Category</th>
                                            <th className='py-3 px-6 text-left font-la'>Date</th>
                                            <th className='py-3 px-6 text-left font-la'>Amount</th>
                                            <th className='py-3 px-6 text-left font-la'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
