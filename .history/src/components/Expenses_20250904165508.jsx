        ...
        <div className='w-full'>
          <form className='p-10 flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
            <div className='flex gap-4'>
              ...
              <input type="text" className='bg-gray-700 rounded-md p-2 w-full' {...register("amount", {required:true})} />
            </div>
            <div className='flex gap-4'>
              <h1 className='text-2xl'>Description</h1>
              <input type="text" className='bg-gray-700 rounded-md p-2 w-full' {...register("description", {required:true})} />
            </div>
          </form>
        </div>
