                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-xl'>Title</th>
                                            <th className='py-3 px-6 text-left font-xl'>Category</th>
                                            <th className='py-3 px-6 text-left font-xl'>Date</th>
                                            <th className='py-3 px-6 text-left font-xl'>Amount</th>
                                            <th className='py-3 px-6 text-left font-xl'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
