                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-lag'>Title</th>
                                            <th className='py-3 px-6 text-left font-lag'>Category</th>
                                            <th className='py-3 px-6 text-left font-lag'>Date</th>
                                            <th className='py-3 px-6 text-left font-lag'>Amount</th>
                                            <th className='py-3 px-6 text-left font-lag'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
