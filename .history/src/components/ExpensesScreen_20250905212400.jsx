                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-lg'>Title</th>
                                            <th className='py-3 px-6 text-left font-lg'>Category</th>
                                            <th className='py-3 px-6 text-left font-lg'>Date</th>
                                            <th className='py-3 px-6 text-left font-lg'>Amount</th>
                                            <th className='py-3 px-6 text-left font-lg'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
