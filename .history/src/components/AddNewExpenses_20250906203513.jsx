        ...
        <div className='w-full'>
          ...
          {errors.title && <p className="text-red-500">{errors.title.message}</p>}
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div className='w-full flex flex-col gap-2'>
                <input
                  ...
                  className='bg-gray-700 rounded-md p-2 flex-1 min-w-0 '
                  {...registe("amount", { required: "Amount is required", min: { value: 0, message: "Amount must be greater than 0" }, valueAsNumber: true })}
                />
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div className='w-full flex flex-col gap-2'>
                <select className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("type", { required: "Type is required" })}>
                  <option value="" className='text-gray-100'>Select Type</option>
