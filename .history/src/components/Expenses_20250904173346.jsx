        ...
        <div className='w-full'>
          <form className='p-10 flex flex-col gap-4' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <input type="text" placeholder='Enter Description' className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("description")} />
            </div>
            <div className='flex gap-4 items-center'>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <select placeholder='Select Category' className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("category", {required:true})}>
                <option className='' value="select">Select Category</option>
