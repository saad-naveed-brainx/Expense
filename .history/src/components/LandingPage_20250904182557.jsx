...
export default function LandingPage() {
  ...
  // This condition filters expenses to only include those whose 'date' is within the last 7 days.
  // It compares each expense's 'date' to a Date object representing 7 days ago.
  const recentExpenses = expenses.filter((expense) => new Date(expense.date) >= new Date(new Date().setDate(new Date().getDate() - 7)))
