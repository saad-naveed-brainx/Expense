        ...
        <div className='w-full'>
          <form id='expenseForm' className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-start'>
              ...
              <div className='w-full flex flex-col gap-2'>
                <input type="date" placeholder='Select Date' className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("date", { required: "Date is required", min: { value: new Date().toISOString() < new Date().toISOString(), message: "Date must not be in future" } })} />
