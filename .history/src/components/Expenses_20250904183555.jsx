        ...
        <div className='w-full'>
          <form id='expenseForm' className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            <div className='flex gap-4 items-center'>
              ...
              <input type="text" placeholder='Enter Title' className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' {...register("title", { required: true, minLength: 3, pattern: /^[a-zA-Z]+$/ message})} />
