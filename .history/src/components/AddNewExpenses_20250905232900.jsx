          ...
          <form id='expenseForm' className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <div className='flex-1 flex flex-col gap-1'>
                <select defaultValue={id ? expense.category : ""} className='bg-gray-700 rounded-md p-3 w-full text-white' {...register("category", { required:"Category must be selected" })}>
            ...
            <div className='flex gap-4 items-start'>
                ...
                <div className='w-full flex flex-col gap-2'>
                  <select className='bg-gray-700 rounded-md p-2 flex-1 min-w-0' defaultValue={id ? expense.type : ""} {...register("type", { required: "Type is required" })}>
