          ...
          <form className='p-10 flex flex-col gap-8' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='flex gap-4 items-center'>
              ...
              <div className='flex items-center gap-2 flex-1'>
                <input type="checkbox" name="reimbersable" id="reimbersable" className='w-5 h-5 rounded-xl checked:bg-green-500 bg-gray-700 border border-gray-500 p-5' {...register("reimbersable")} />
