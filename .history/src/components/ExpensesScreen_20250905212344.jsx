                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-large'>Title</th>
                                            <th className='py-3 px-6 text-left font-large'>Category</th>
                                            <th className='py-3 px-6 text-left font-large'>Date</th>
                                            <th className='py-3 px-6 text-left font-large'>Amount</th>
                                            <th className='py-3 px-6 text-left font-large'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
