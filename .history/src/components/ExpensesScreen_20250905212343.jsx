                            ...
                            <div className="relative">
                                <table className="w-full table-fixed">
                                    ...
                                    <thead className="text-gray-400 text-sm bg-black">
                                        <tr>
                                            <th className='py-3 px-6 text-left font-lar'>Title</th>
                                            <th className='py-3 px-6 text-left font-lar'>Category</th>
                                            <th className='py-3 px-6 text-left font-lar'>Date</th>
                                            <th className='py-3 px-6 text-left font-lar'>Amount</th>
                                            <th className='py-3 px-6 text-left font-lar'>Actions</th>
                                        </tr>
                                    </thead>
                                </table>
